...
namespace Kbg.NppPluginNET
{
    class Main : IDisposable
    {
        ...
        internal static void CommandMenuInit()
        {
            ...
            someSetting = (Win32.GetPrivateProfileInt("Parsify", "Toggle", 0, iniFilePath) != 0);

            PluginBase.SetCommand(0, "Open", StartParsify); parsifyId = 0;
        }
        ...
        {
            Win32.WritePrivateProfileString("Parsify", "Toggle", someSetting ? "1" : "0", iniFilePath);
        }

        internal static void StartParsify()
        {
            if (coreWindow == null)
            {
            ...
            {
                Win32.SendMessage(PluginBase.nppData._nppHandle, (uint) NppMsg.NPPM_DMMSHOW, 0, coreWindow.Handle);
            }
        }
